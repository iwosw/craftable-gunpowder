...
|---|---|
| 1.20.1, 1.20.4, 1.20.6, 1.21.1 | Fabric, Forge, NeoForge |
| 1.21.4, 1.21.5, 1.21.8, 1.21.11, 26.1, 26.2 | Fabric, NeoForge |

Выбери **один JAR**, соответствующий точной версии Minecraft и загрузчику. Для Fabric также нужен **Fabric API**. Мод устанавливается на клиент и сервер. Руда появится в новых чанках.

Для Minecraft 26.1 используется NeoForge **26.1.0.19-beta**; этот файл не предназначен для 26.1.2. Требуемые номера загрузчиков закреплены в `versions.json`.
